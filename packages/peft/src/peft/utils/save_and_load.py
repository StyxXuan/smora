...
def get_peft_model_state_dict(
    ...
    elif config.peft_type == PeftType.SRMOLE or config.peft_type == PeftType.MOELORA or config.peft_type == PeftType.HYDRALORA or config.peft_type == PeftType.MOSLORA:
        bias = config.bias
        if bias == "none":
