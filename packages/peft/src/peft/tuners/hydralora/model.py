...
class HydraLoRAModel(LoraModel):
    """
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if not isinstance(target, HydraLoRALayer):
    ...
    def _create_new_module(lora_config, adapter_name, target, **kwargs):
        ...
        if loaded_in_8bit and isinstance(target_base_layer, bnb.nn.Linear8bitLt):
            ...
            new_module = HydraLoRALinear8bitLt(target, adapter_name, **kwargs)
            ...
            new_module = HydraLoRALinear4bitLt(target, adapter_name, **fourbit_kwargs)
        elif AutoGPTQQuantLinear is not None and isinstance(target, AutoGPTQQuantLinear):
            new_module = HydraLoRAQuantLinear(target, adapter_name, **kwargs)
        else:
            ...
            new_module = HydraLoRALinear(target, adapter_name, **kwargs)
