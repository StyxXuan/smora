...
class SRMoLEConfig(LoraConfig):
    """
    This is the configuration class to store the configuration of a [`~peft.SRMoLE`].
    ...
    dense_compute: bool = field(default=False, metadata={"help": "dense compute in srmole"})
