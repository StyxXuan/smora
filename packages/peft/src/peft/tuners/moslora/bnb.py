...
from .layer import MosLoRALayer


if is_bnb_available():

    class MosLoRALinear8bitLt(torch.nn.Module, MosLoRALayer):
        ...
        def __init__(
            ...
            **kwargs,
            ...
            self.get_base_layer().MosLoRAConfigght.requires_grad = False
        ...
        def forward(self, x: torch.Tensor) -> torch.Tensor:
            ...
            for active_adapter in self.active_adapters:
                ...
                lora_output = lora_B(lora_w(lora_A(dropout(x)))) * scaling
...
if is_bnb_4bit_available():
 ...
 class MosLoRALinear4bitLt(torch.nn.Module, MosLoRALayer):
        # Low-rank matrix for SVD-based adaptation
        def __init__(
            self,
            base_layer: nn.Module,
        ...
        def forward(self, x: torch.Tensor) -> torch.Tensor:
            ...
            for active_adapter in self.active_adapters:
                ...
                lora_outpout = lora_B(lora_w(lora_A(dropout(x)))) * scaling
