...
from .gptq import MosLoRAQuantLinear
from .layer import MosLoRALayer, MosLoRALinear
...
class MosLoRAModel(LoraModel):
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if not isinstance(target, MosLoRALayer):
    ...
    def _create_new_module(lora_config, adapter_name, target, **kwargs):
        ...
        if is_bnb_available():
            ...
            from .bnb import MosLoRALinear8bitLt
        if is_bnb_4bit_available():
            from .bnb import MosLoRALinear4bitLt
        ...
        if loaded_in_8bit and isinstance(target_base_layer, bnb.nn.Linear8bitLt):
            ...
            new_module = MosLoRALinear8bitLt(target, adapter_name, **kwargs)
            ...
            new_module = MosLoRALinear4bitLt(target, adapter_name, **fourbit_kwargs)
        elif AutoGPTQQuantLinear is not None and isinstance(target, AutoGPTQQuantLinear):
            new_module = MosLoRAQuantLinear(target, adapter_name, **kwargs)
        else:
            ...
            new_module = MosLoRALinear(target, adapter_name, **kwargs)
