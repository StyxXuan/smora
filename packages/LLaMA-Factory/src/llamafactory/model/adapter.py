...
import torch
from peft import LoraConfig, LoraModel, PeftModel, TaskType, get_peft_model, SRMoLEConfig, AdaLoraConfig, IA3Config, MoELoRAConfig, HydraLoRAConfig, MosLoRAConfig
...
def _setup_lora_tuning(
    ...
    if is_trainable and adapter_to_resume is None:  # create new lora weights while training
        ...
        # todo
        if finetuning_args.lora_type == "lora":
            peft_kwargs = {
        ...
        elif finetuning_args.lora_type == "srmole":
            peft_kwargs = {
                "r": finetuning_args.lora_rank,
                "activate_r": finetuning_args.activate_r,
                "epsilon_greedy": finetuning_args.epsilon_greedy,
                "rank_partition": finetuning_args.rank_partition,
                "target_modules": target_modules,
                "lora_alpha": finetuning_args.lora_alpha,
                "lora_dropout": finetuning_args.lora_dropout,
                "modules_to_save": finetuning_args.additional_target,
            }
        elif finetuning_args.lora_type == "adalora":
            peft_kwargs = {
                "init_r": finetuning_args.lora_rank,
                "target_r": finetuning_args.lora_rank // 2,
                "target_modules": target_modules,
                "lora_alpha": finetuning_args.lora_alpha,
                "lora_dropout": finetuning_args.lora_dropout,
                "use_rslora": finetuning_args.use_rslora,
        ...
        elif finetuning_args.lora_type == "ia3":
            peft_kwargs = {
                "target_modules": target_modules,
                "modules_to_save": finetuning_args.additional_target,
            }
        elif finetuning_args.lora_type == "moelora":
            peft_kwargs = {
                "r": finetuning_args.lora_rank,
                "expert_num": finetuning_args.expert_num,
                "routing_strategy": finetuning_args.routing_strategy,
                "target_modules": target_modules,
                "lora_alpha": finetuning_args.lora_alpha,
                "lora_dropout": finetuning_args.lora_dropout,
                "use_rslora": finetuning_args.use_rslora,
        ...
        elif finetuning_args.lora_type == "hydralora":
            peft_kwargs = {
                "r": finetuning_args.lora_rank,
                "expert_num": finetuning_args.expert_num,
                "target_modules": target_modules,
        ...
        elif finetuning_args.lora_type == "moslora":
            peft_kwargs = {
                "r": finetuning_args.lora_rank,
                "target_modules": target_modules,
                "lora_alpha": finetuning_args.lora_alpha,
