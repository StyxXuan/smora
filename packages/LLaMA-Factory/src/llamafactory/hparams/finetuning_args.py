...
class LoraArguments:
    ...
    activate_r: int = field(
        default=8,
        metadata={"help": "activate rank"},
    )
    epsilon_greedy: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the epsilon-greedy in srmole."},
    )
    rank_partition: int = field(
        default=1,
        metadata={"help": "rank partition in srmole"},
    )
    
    expert_num: int = field(
        default=8,
        metadata={"help": "expert_num in moelora"},
    )
    
    routing_strategy: str = field(
        default="top-1",
        metadata={"help": "routing_strategy in moelora"},
    )
